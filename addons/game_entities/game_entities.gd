...
func _enter_tree():
	...
	add_custom_type("GAME_MessageInfoPanel", "Area2D", load(path+'game_node_msginfo.gd'), load(path+'game_node_icon_msginfo.png'))
	add_custom_type("GAME_PlayerStart", "Area2D", load(path+'game_node_playerstart.gd'), load(path+'game_node_icon_playerstart.png'))
...
func _exit_tree():
	...
	remove_custom_type("GAME_MessageInfoPanel")
	remove_custom_type("GAME_PlayerStart")
